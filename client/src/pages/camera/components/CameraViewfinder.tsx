  ...
  return (
    ...
    >
      ...
      {showMaskButton && onMask && !adjustmentMode && (
        <button
          className="absolute right-4 top-32 z-30 safe-top w-14 h-14 flex items-center justify-center bg-card/80 backdrop-blur-md rounded-xl border border-border/10 shadow-md hover:bg-card transition-colors"
          onClick={onMask}
