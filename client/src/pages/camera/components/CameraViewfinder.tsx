  ...
  return (
    ...
    >
      ...
      {showMaskButton && onMask && !adjustmentMode && (
        <button
          className="absolute right-4 top-32 z-30 safe-top flex items-center justify-center bg-card/60 rounded-xl p-2 border border-border/30 shadow-md transition-colors"
          onClick={onMask}
