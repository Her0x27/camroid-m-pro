  ...
  return (
    ...
    >
      ...
      {showMaskButton && onMask && !adjustmentMode && (
        <button
          className="absolute right-4 top-32 z-30 safe-top w-14 h-14 flex items-center justify-center bg-transparent rounded-xl border border-border/30 shadow-md transition-colors"
          onClick={onMask}
