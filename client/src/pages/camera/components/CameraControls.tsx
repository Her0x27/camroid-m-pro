...
const GalleryButton = memo(function GalleryButton({
  ...
  return (
    <div className="absolute left-4 flex items-center">
      <button
        className="bg-card/60 rounded-xl p-2 border border-border/30 shadow-sm relative transition-opacity active:opacity-70"
        onClick={onNavigate}
  ...
  return (
    <div className="absolute right-4 flex items-center gap-2">
      ...
      <div className="relative">
        {showEditorIcon && (
          <button
            className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-card/60 rounded-xl p-2 border border-border/30 shadow-sm transition-all animate-in fade-in zoom-in-90 duration-200"
        ...
        <button
          className="bg-card/60 rounded-xl p-2 border border-border/30 shadow-sm transition-opacity active:opacity-70"
